...
/*Produced by NSL Core(version=20240708), IP ARCH, Inc. Sat Dec 28 06:01:23 2024
...
module camera ( p_reset , m_clock , in_data , href , pclk , xclk , c_vsync , sda , scl , reset , pwdn , VGA_R , VGA_B , VGA_G , out_plot_num_x , time_RGB , out_plot_num_y );
  ...
  wire _net_40;
   ...
   assign  _net_0 = ((pc < 10'b0001111110)&(((((scl_clk==16'b0000000000001010)&(((start_count > 32'b00000000000000000000000011001110)&(pc==10'b0000000000))|((start_count > 32'b00000000000000001110100111111011)&(pc != 10'b0000000000))))&(I2C_START_STOP < 4'b1000))|(count==10'b0000011010))|(((scl_clk==16'b0000000000001010)&(count==10'b0000011001))&(start_count > 32'b00000000000000000000000011001110))));
   assign  _net_1 = 
...
// synthesis translate_on
// synopsys translate_on
((_net_18)?(((pc < 10'b0001111110)&(scl_clk==16'b0000000000001010))&(4'b1000 > I2C_START_STOP)):1'b0)
// synthesis translate_off
// synopsys translate_off
:1'bx
// synthesis translate_on
...
;
   assign  xclk = clk;
   assign  sda = ((((((((((count==10'b0000011001)&(I2C_START_STOP==10'b0000000001))|((count==10'b0000010000)&(I2C_START_STOP==10'b0000000000)))|((count==10'b0000011000)&(I2C_START_STOP==10'b0000001000)))|((start_count < 32'b00000000000000000000000000000101)&(pc==10'b0000000000)))|((start_count < 32'b00000000000000001110100100110010)&(pc != 10'b0000000000)))|(count==10'b0000011010))|(sda_reg&(count != 10'b0000011001)))|(I2C_START_STOP==10'b0000001000))|((((I2C_START_STOP==10'b0000000001)&(scl_clk < 16'b0000000000001010))&sda_reg)&(pc==10'b0000000000)));
   assign  scl = ((((((((count==10'b0000011001)&(I2C_START_STOP==10'b0000000001))|scl_reg)|((start_count < 32'b00000000000000000000000011001111)&(pc==10'b0000000000)))|((start_count < 32'b00000000000000001110100111111100)&(pc != 10'b0000000000)))|(pc==10'b0001111110))|(count==10'b0000011010))|((count==10'b0000011001)&(I2C_START_STOP==10'b0000001000)));
   assign  VGA_R = arg_r;
   assign  VGA_B = arg_b;
   assign  VGA_G = arg_g;
...
initial begin
    sda_OV[0] = 16'b0001001000000100;
    sda_OV[1] = 16'b0100000011010000;
    sda_OV[2] = 16'b1000110000000010;
    sda_OV[3] = 16'b0111000000111010;
    sda_OV[4] = 16'b0111000100110101;
    sda_OV[5] = 16'b0111001000010001;
    sda_OV[6] = 16'b0111001111110000;
    sda_OV[7] = 16'b1010001000000010;
    sda_OV[8] = 16'b0001010100000000;
    sda_OV[9] = 16'b0111101000100000;
    sda_OV[10] = 16'b0111101100010000;
    sda_OV[11] = 16'b0111110000011110;
    sda_OV[12] = 16'b0111110100110101;
    sda_OV[13] = 16'b0111111001011010;
    sda_OV[14] = 16'b0111111101101001;
    sda_OV[15] = 16'b1000000001110110;
    sda_OV[16] = 16'b1000000110000000;
    sda_OV[17] = 16'b1000001010001000;
    sda_OV[18] = 16'b1000001110001111;
    sda_OV[19] = 16'b1000010010010110;
    sda_OV[20] = 16'b1000010110100011;
    sda_OV[21] = 16'b1000011010101111;
    sda_OV[22] = 16'b1000011111000100;
    sda_OV[23] = 16'b1000100011010111;
    sda_OV[24] = 16'b1000100111101000;
    sda_OV[25] = 16'b0001001111100000;
    sda_OV[26] = 16'b0000000000000000;
    sda_OV[27] = 16'b0001000000000000;
    sda_OV[28] = 16'b0000110101000000;
    sda_OV[29] = 16'b0001010000011000;
    sda_OV[30] = 16'b1010010100000101;
    sda_OV[31] = 16'b1010101100000111;
    sda_OV[32] = 16'b0010010010010101;
    sda_OV[33] = 16'b0010010100110011;
    sda_OV[34] = 16'b0010011011100011;
    sda_OV[35] = 16'b1001111101111000;
    sda_OV[36] = 16'b1010000001101000;
    sda_OV[37] = 16'b1010000100000011;
    sda_OV[38] = 16'b1010011011011000;
    sda_OV[39] = 16'b1010011111011000;
    sda_OV[40] = 16'b1010100011110000;
    sda_OV[41] = 16'b1010100110010000;
    sda_OV[42] = 16'b1010101010010100;
    sda_OV[43] = 16'b0001001111100101;
    sda_OV[44] = 16'b0000111001100001;
    sda_OV[45] = 16'b0000111101001011;
    sda_OV[46] = 16'b0001011000000010;
    sda_OV[47] = 16'b0001111000000111;
    sda_OV[48] = 16'b0010000100000010;
    sda_OV[49] = 16'b0010001010010001;
    sda_OV[50] = 16'b0010100100000111;
    sda_OV[51] = 16'b0011001100001011;
    sda_OV[52] = 16'b0011010100001011;
    sda_OV[53] = 16'b0011011100011101;
    sda_OV[54] = 16'b0011100001110001;
    sda_OV[55] = 16'b0011100100101010;
    sda_OV[56] = 16'b0011110001111000;
    sda_OV[57] = 16'b0100110101000000;
    sda_OV[58] = 16'b0100110100110100;
    sda_OV[59] = 16'b0100111000100000;
    sda_OV[60] = 16'b0110100100000000;
    sda_OV[61] = 16'b0110101100001010;
    sda_OV[62] = 16'b0111010000010000;
    sda_OV[63] = 16'b1000110101001111;
    sda_OV[64] = 16'b1000111000000000;
    sda_OV[65] = 16'b1000111100000000;
    sda_OV[66] = 16'b1001000000000000;
    sda_OV[67] = 16'b1001000100000000;
    sda_OV[68] = 16'b1001011000000000;
    sda_OV[69] = 16'b1001101000000000;
    sda_OV[70] = 16'b1011000010000100;
    sda_OV[71] = 16'b1011000100001100;
    sda_OV[72] = 16'b1011001000001110;
    sda_OV[73] = 16'b1011001110000010;
    sda_OV[74] = 16'b1011100000001010;
    sda_OV[75] = 16'b0100001100001010;
    sda_OV[76] = 16'b0100010011110000;
    sda_OV[77] = 16'b0100010100110100;
    sda_OV[78] = 16'b0100100000111010;
    sda_OV[79] = 16'b0101100110011001;
    sda_OV[80] = 16'b0101101010001000;
    sda_OV[81] = 16'b0101101101000100;
    sda_OV[82] = 16'b0101110001100111;
    sda_OV[83] = 16'b0101110101001001;
    sda_OV[84] = 16'b0101111000001110;
    sda_OV[85] = 16'b0110110000001010;
    sda_OV[86] = 16'b0110110101010101;
    sda_OV[87] = 16'b0110111000010001;
    sda_OV[88] = 16'b0110111110011111;
    sda_OV[89] = 16'b0110101001000000;
    sda_OV[90] = 16'b0000000101000000;
    sda_OV[91] = 16'b0000001001100000;
    sda_OV[92] = 16'b0001001111100111;
    sda_OV[93] = 16'b0100111110000000;
    sda_OV[94] = 16'b0101000010000000;
    sda_OV[95] = 16'b0101000100000000;
    sda_OV[96] = 16'b0101001000100010;
    sda_OV[97] = 16'b0101001101011110;
    sda_OV[98] = 16'b0101010010000000;
    sda_OV[99] = 16'b0101100010011110;
    sda_OV[100] = 16'b0100000100001000;
    sda_OV[101] = 16'b0011111100000000;
    sda_OV[102] = 16'b0111010100000101;
    sda_OV[103] = 16'b0111011011100001;
    sda_OV[104] = 16'b0100110000000000;
    sda_OV[105] = 16'b0111011100000001;
    sda_OV[106] = 16'b0011110111000011;
    sda_OV[107] = 16'b0100101100001001;
    sda_OV[108] = 16'b1100100101100000;
    sda_OV[109] = 16'b0100000100111000;
    sda_OV[110] = 16'b0101100001100000;
    sda_OV[111] = 16'b0011010000010001;
    sda_OV[112] = 16'b0011101100010010;
    sda_OV[113] = 16'b1010010010001000;
    sda_OV[114] = 16'b1001011000000000;
    sda_OV[115] = 16'b1001011100110000;
    sda_OV[116] = 16'b1001100000100000;
    sda_OV[117] = 16'b1001100100110000;
    sda_OV[118] = 16'b1001101010000100;
    sda_OV[119] = 16'b1001101100101001;
    sda_OV[120] = 16'b1001110000000011;
    sda_OV[121] = 16'b1001110101001100;
    sda_OV[122] = 16'b1001111000111111;
    sda_OV[123] = 16'b0111100000000100;
    sda_OV[124] = 16'b0111100100000001;
    sda_OV[125] = 16'b1100100011110000;
    sda_OV[126] = 16'b1111111111111111;
    sda_OV[127] = 16'b1111111111111111;
    sda_OV[128] = 0;
    sda_OV[129] = 0;
    sda_OV[130] = 0;
    sda_OV[131] = 0;
